...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Servico sv1 = new Servico(1, "Completa", 10);
        Servico sv2 = new Servico(2, "Pretinho", 20);
        Servico sv3 = new Servico(3, "Trocar Oleo", 30);
        
        OrdemServico os = new OrdemServico(1,LocalDate.now(),5);
        ItemOS item1 = new ItemOS("Alguma coisa 1", sv1);
        ItemOS item2 = new ItemOS("Alguma coisa 2", sv2);
        ItemOS item3 = new ItemOS("Alguma coisa 3", sv3);
