...
public class PessoaFisica extends Cliente{ // Uma das espcializações da classe Cliente
    // Atributos
    private String cpf;
    ...
    public String getDados() {
        return  "Cliente{" + "cpf=" + cpf + ", dataNascimento="+ dataNascimento +" "+ super.getDados() +'}';
    }

    @Override
    public String getDados(String Observacao) {
        return  "Cliente{" + "cpf=" + cpf + ", dataNascimento="+ dataNascimento +" "+ super.getDados(Observacao) +'}';
    }
